...
//)
//
//// CloudFlareRoundTripper is a http client RoundTripper that can handle the Cloudflare anti-bot.
//type CloudFlareRoundTripper struct {
//	upstream http.RoundTripper
//	cookies  http.CookieJar
//}
//
//// NewCloudflareRoundTripper wraps a http client transport with one that can handle the Cloudflare anti-bot.
//func NewCloudflareRoundTripper(upstream http.RoundTripper) (*CloudFlareRoundTripper, error) {
//	jar, err := cookiejar.New(nil)
//	if err != nil {
//		return nil, err
//	}
//	return &CloudFlareRoundTripper{upstream, jar}, nil
//}
//
//// RoundTrip implements the RoundTripper interface for the Transport type.
//func (rt CloudFlareRoundTripper) RoundTrip(r *http.Request) (*http.Response, error) {
//	if r.Header.Get("User-Agent") == "" {
//		r.Header.Set("User-Agent", GenerateRandomUserAgent())
//	}
