...
// NewRoundTripper wraps a http client transport with one that can handle the Cloudflare anti-bot.
func NewRoundTripper(upstream http.RoundTripper) (*CloudFlareRoundTripper, error) {
