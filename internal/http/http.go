...
func NewClient(doer Doer) *Client {
	...
	//var err error
	//httpClient.Transport, err = NewCloudflareRoundTripper(httpClient.Transport)
	//
	//if err != nil {
...
//	if err != nil {
//		return nil,fmt.Errorf("getting document from reader, err: %v",err)
//	}
...
func (c Client) ScrapeByCode(code, ext string) (scrapmon.ScrapedFile, error) {
	...
	url := "https://i.imgur.com/" + code + "." + ext
